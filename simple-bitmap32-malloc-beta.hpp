 ...
 * 
 * 0.31:
 * - Not working functions are only active if sbtmp_experimental is defined.
 * 
 * 
 * TODO:
 * - fix invert function
...
namespace sbtmp{
    ...
    class bitmap{
        ...
        #ifdef sbtmp_experimental
        void invert(uint32_t x_pos, uint32_t y_pos, uint32_t width_set, uint32_t height_set){
